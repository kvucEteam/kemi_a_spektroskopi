...
function check_svar() {
	...
	var radioButtons11 = document.getElementsByName("svar3_1");
	
	var radioButtons12 = document.getElementsByName("svar3_2");
	
	var radioButtons13 = document.getElementsByName("svar3_3");
	
	var radioButtons14 = document.getElementsByName("svar3_4");
	
	var radioButtons15 = document.getElementsByName("svar3_5");
	
	var radioButtons16 = document.getElementsByName("svar4_1");
	
	var radioButtons17 = document.getElementsByName("svar4_2");
	
	var radioButtons18 = document.getElementsByName("svar4_3");
	...
	var radioButtons = new Array(radioButtons1, radioButtons2, radioButtons3, radioButtons4, radioButtons5, radioButtons6, radioButtons7, radioButtons8, radioButtons9, radioButtons10, radioButtons11, radioButtons12, radioButtons13, radioButtons14, radioButtons15, radioButtons16, radioButtons17, radioButtons18, radioButtons19, radioButtons20);
